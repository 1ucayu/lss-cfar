...
parser.add_argument('--depth_cam_isRaw', type=bool, default=True, help='Enable raw depth camera data')
...
if __name__ == '__main__':
    ...
    while not stop_flag:
        ...
        processed_data = processed_data[0, 14:101, :142]
        ...
        if save_data:
            ...
            fig4 = plt.figure(figsize=(10, 6))
            ax4 = fig4.add_subplot(111)
            ax4.imshow(processed_data, extent=[0, depth_cam_config['max_range'], -depth_cam_config['fov_azi'] / 2, depth_cam_config['fov_azi'] / 2], aspect='auto', cmap='viridis', alpha=0.5)
            ax4.scatter(range_cam, azimuth_cam_deg, s=1, c='black', label='Depth Camera')
            ax4.set_xlim(0, depth_cam_config['max_range'])
            ax4.set_ylim(-depth_cam_config['fov_azi'] / 2, depth_cam_config['fov_azi'] / 2)
